...
export interface ApiDepartmentStatisticDepartmentStatistic
  extends Struct.SingleTypeSchema {
  collectionName: 'department_statistics';
  info: {
    description: 'Department statistics including faculty count, student count, placements, etc.';
    displayName: 'Department Statistics';
    pluralName: 'department-statistics';
    singularName: 'department-statistic';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    averageCTC: Schema.Attribute.String;
    courses: Schema.Attribute.Integer & Schema.Attribute.DefaultTo<0>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    facultyMembers: Schema.Attribute.Integer & Schema.Attribute.DefaultTo<0>;
    highestCTC: Schema.Attribute.String;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
    ...
    > &
      Schema.Attribute.Private;
    medianCTC: Schema.Attribute.String;
    placementPercentage: Schema.Attribute.String;
    placementYear: Schema.Attribute.Integer;
    publications: Schema.Attribute.Integer & Schema.Attribute.DefaultTo<0>;
    publishedAt: Schema.Attribute.DateTime;
    researchLabs: Schema.Attribute.Integer & Schema.Attribute.DefaultTo<0>;
    students: Schema.Attribute.Integer & Schema.Attribute.DefaultTo<0>;
    totalOffers: Schema.Attribute.Integer & Schema.Attribute.DefaultTo<0>;
    totalStudentsPlaced: Schema.Attribute.Integer &
      Schema.Attribute.DefaultTo<0>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    yearsOfService: Schema.Attribute.Integer & Schema.Attribute.DefaultTo<0>;
  };
}
...
export interface ApiFuzzySearchFuzzySearch extends Struct.CollectionTypeSchema {
  collectionName: 'fuzzy_searches';
  info: {
    displayName: 'FuzzySearch';
    pluralName: 'fuzzy-searches';
    singularName: 'fuzzy-search';
  };
  options: {
    draftAndPublish: false;
  };
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::department-statistic.department-statistic': ApiDepartmentStatisticDepartmentStatistic;
      'api::electivecourse.electivecourse': ApiElectivecourseElectivecourse;
      'api::faq.faq': ApiFaqFaq;
      'api::fuzzy-search.fuzzy-search': ApiFuzzySearchFuzzySearch;
