    ...
    <Section id="courses" title="Courses">
     ...
     <div className="bg-white rounded-lg shadow-sm p-6">
      ...
      <div className="mt-4 text-center">
        <p className=" mb-1">
          The list includes both core and elective Electrical Engineering
          courses.
        </p>
        ...
        <a
          href="https://iitdh.ac.in/sites/default/files/2025-01/Electrical%20Engineering01-15-25.pdf"
          target="_blank"
          rel="noopener noreferrer"
          className="inline-block px-4 py-2 text-white text-sm font-medium rounded-lg shadow hover:opacity-90 transition"
